...
namespace Assets
{
    class GpsPosData
    {
        ...
        private double longitude;   // 経度(WGS84/ellipsoidal)
        private double height;      // 標高(WGS84/ellipsoidal)
        private int quality;        // 1:fix,2:float,3:sbas,4:dgps,5:single,6:ppp
        private int ns;             // # of satellites
        private double sdn;
        private double sde;
        private double sdu;
        private double sdne;
